...
const buttonTap = { scale: 0.95, transition: { type: 'spring', stiffness: 500, damping: 30 } };
const buttonHover = { scale: 1.05, y: -1, transition: { type: 'spring', stiffness: 400, damping: 25 } };
